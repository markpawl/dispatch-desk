...
This is still an early concept — see `IDEAS.md` for open questions and `PLATFORM-COMPONENTS.md` /
`PLATFORM-ARCHITECTURE.md` for design once components and structure are decided.
